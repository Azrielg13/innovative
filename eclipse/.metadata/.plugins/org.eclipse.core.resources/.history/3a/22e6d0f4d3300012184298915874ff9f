...
public class SpiderChartApp extends AbstractSampleApp
{
	...
	public void fill() throws JRException
	{
		...
		try
		{
			...
			cds = new JRCsvDataSource(JRLoader.getLocationInputStream("spiderDatasource.csv"), "UTF-8");
		...
		JasperFillManager.fillReportToFile("SpiderChart.jasper", null, cds);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToPdfFile("SpiderChart.jrprint");
