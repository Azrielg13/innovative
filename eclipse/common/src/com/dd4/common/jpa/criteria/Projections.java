 ...
 * factory methods of this class.<br/>
 * <br/>
 * The factory methods that take an alias allow the projected value to be
 * referred to by criterion and order instances.
 * 
...
public final class Projections {
	 ...
	 */
	public static Projection sqlProjection(String sql, String[] columnAliases) {
	 ...
	 * clause fragments
	 */
	public static Projection sqlGroupProjection(String sql, String groupBy, String[] columnAliases) {
	...
	public static Projection sqlGroupProjection(String sql, String groupBy) {
		return new SQLProjection(sql, groupBy);
	}
