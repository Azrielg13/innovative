...
public class Restrictions {
	...
	public static LikeExpression like(String propertyName, String value, MatchMode matchMode, char escapeChar) {
		return new LikeExpression(propertyName, value, matchMode, escapeChar);
	}
	 ...
	 * @return Criterion
	 */
	public static LikeExpression ilike(String propertyName, String value) {
		return new LikeExpression(propertyName, value, null, true);
	}
	 ...
	 * @return Criterion
	 */
	public static LikeExpression ilike(String propertyName, String value, MatchMode matchMode) {
		return new LikeExpression(propertyName, value, matchMode, null, true);
	}

	public static LikeExpression ilike(String propertyName, String value, MatchMode matchMode, char escapeChar) {
	...
	// * @return Criterion
	// */
	// public static Criterion sqlRestriction(String sql, Object value, Type
	// type) {
	...
	// TODO c4jpql SizeExpression need to be implemented
	/**
