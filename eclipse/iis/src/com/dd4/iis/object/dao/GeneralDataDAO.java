...
import com.dd4.iis.object.model.GeneralData;
...
public abstract class GeneralDataDAO extends DataAccessObject{
	...
	public static Collection<GeneralData> getAll()throws java.sql.SQLException{
		return getNamedCollection("findAll");
	}
	public static Collection<GeneralData> getAllActive()throws java.sql.SQLException{
		return getNamedCollection("findAllActive");
	}
	public static Collection<GeneralData> getCollection(String[] props, Object... values)throws java.sql.SQLException{
	...
	public synchronized static Collection<GeneralData> getCollection(String jpql, Object... values)throws java.sql.SQLException{
		EntityManager em = EntityManagerHelper.getEntityManager();
	...
	public synchronized static Collection<GeneralData> getNamedCollection(String name, Object... values)throws java.sql.SQLException{
		EntityManager em = EntityManagerHelper.getEntityManager();
	...
	public GeneralData getGroup()throws java.sql.SQLException{
		if(group==null)
			group=GeneralData.getInstance(getGroupId());
		return group;
	}
	public void setGroup(GeneralData group)throws java.sql.SQLException{
		setGroupId(group==null?0:group.getId());
		this.group=group;
	}
	public Collection<GeneralData> getGeneralDatas()throws java.sql.SQLException{
	...
	public void addGeneralData(GeneralData generalData)throws java.sql.SQLException{
	...
	public void removeGeneralData(GeneralData generalData)throws java.sql.SQLException{
		if(isNewInstance() || generalDatas != null)
			getGeneralDatas().remove(generalData);
		else
			generalData.delete();
	}
	public GeneralData copy()throws java.sql.SQLException{
		GeneralData cp = new GeneralData((GeneralData)this);
		copyChildrenTo(cp);
		return cp;
	}
	public void copyChildrenTo(GeneralDataDAO cp)throws java.sql.SQLException{
