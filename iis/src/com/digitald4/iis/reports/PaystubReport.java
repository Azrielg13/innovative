...
public class PaystubReport extends PDFReport {
	...
	public Paragraph getBody() throws Exception {
		...
		for (Appointment appointment : getAppointments()) {
			...
			datatable.addCell(getCell(FormatText.CURRENCY.format(appointment.getPayRate())));
			datatable.addCell(getCell(FormatText.CURRENCY.format(appointment.getPayFlat())));
			datatable.addCell(getCell(FormatText.CURRENCY.format(appointment.getGrossTotal())));
			cell = getCell("" + appointment.getPayMileage());
			cell.setBorder(Rectangle.LEFT);
			datatable.addCell(cell);
			datatable.addCell(getCell(FormatText.CURRENCY.format(appointment.getPayMileageTotal())));
		}
