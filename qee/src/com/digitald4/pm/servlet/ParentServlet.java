...
import com.digitald4.util.Company;
...
public class ParentServlet extends HttpServlet{
   ...
   public static boolean isAuthorized(HttpServletRequest request, HttpServletResponse response, Client client)throws IOException{
