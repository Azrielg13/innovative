...
public class Client extends User{
	...
	public boolean setField(String field, String value)throws Exception{
		switch(field.charAt(0)){
			...
			case 'i': if(field.charAt(3) == 'a'){
							setInsAmount(value); return true;
						}else{
							setIns(InsuranceCo.getInsuranceCo(Integer.parseInt(value))); return true;
					}
	...
	public void setLastUpdate()throws Exception{
		setProp("last_update",MYSQL_DATE_TIME.format(Calendar.getInstance().getTimeInMillis()));
