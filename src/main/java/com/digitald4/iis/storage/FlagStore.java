...
public class FlagStore extends GenericStore<Flag, String> {
  ...
  public ImmutableList<Flag> getPermissions() {
    ...
    return ImmutableList.of(
        ...
        Flag.of("pendingAssessmentsEnabled",
                role == ADMIN || role == RCO || role == CC || role == SB || role == RC ||role == NURSE),
        Flag.of("appointmentsCompletedEnabled", role == NURSE),
        ...
        Flag.of("openReferralsEnabled", false),
