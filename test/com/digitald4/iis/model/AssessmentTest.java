...
public class AssessmentTest extends DD4TestCase {
	...
	public void testAssTabs() throws Exception {
		...
		at.setAppointment(new Appointment(entityManager).setPatient(new Patient(entityManager)));
		System.out.println(at.getOutputIndented());
	}

	@Test
	public void testSetProperty() throws Exception {
		Appointment app = new Appointment(entityManager);
		app.setPatient(Patient.getAll(Patient.class, entityManager).get(0));
		app.setNurse(Nurse.getAll(Nurse.class, entityManager).get(0));
	...
	public void testGetValue() throws Exception {
		...
		Appointment app = new Appointment(entityManager).setStart(DateTime.now().minusDays(1));
		patient.addAppointment(app);
		app.setPropertyValue("55", "comment");
		assertEquals("comment", app.getAssessmentValue(55));
		Appointment app2 = new Appointment(entityManager).setStart(DateTime.now());
